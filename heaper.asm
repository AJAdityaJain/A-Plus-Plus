...
import kernel,\ExitProcess,'ExitProcess',\beep,'Beep',\HeapCreate, 'HeapCreate'
import msvcrt,\printf, 'printf',\scanf, 'scanf',\malloc,'malloc',\free,'free',\realloc,'realloc'
...
genlist:
    ...
    ;rdx has internal alloc and rax has 16byte framing
	mov qword [rax], rdx
	mov dword [rax+8], 0
